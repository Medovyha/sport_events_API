...
public class UpdateEventUseCase {
    ...
    public EventResult execute(UpdateEventCommand command) {
        ...
        Event savedEvent = eventRepository.save(new Event(command.eventId(), command.startsAt(), command.venueId()));
        ...
        for (EventTranslationCommand translationCommand : translations) {
            ...
            Integer existingTranslationId = eventTranslationRepository
                    .findByEventIdAndLanguageId(savedEvent.getEventId(), language.getLanguageId())
                    .map(EventTranslation::getEventTranslationId)
                    .orElse(null);
